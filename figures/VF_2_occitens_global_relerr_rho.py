...
# file_rho    = sio.loadmat('E:\\OLIV3_figures\\OCCITENS\\rho_w_wglvb_occitens_glob_025_annual_isolevm_filtr.mat')
...
# file_relerr = sio.loadmat('E:\\OLIV3_figures\\OCCITENS\\relerr_w_wglvb_occitens_glob_025_annual_isolevm_filtr.mat')
...
# file_lvb    = sio.loadmat('E:\\OLIV3_figures\\OCCITENS\\lvb_validity_occitens_glob_025_23yr_isolevm_filtr.mat')
...
# 10/10-50/50-200 Delta_w relative error ------------------------------------
...
cb = fig.colorbar(
    mpl.cm.ScalarMappable(cmap=newcmp_rel, norm=norm_rel),
    extend='max',
    ticks=bounds_rel,
...
#plt.savefig('global_rel_err.png', bbox_inches='tight', dpi=300)
...
# Highlight contours
hc = ax1.contour(lon, lat, rho[:,:,k], levels=[0.7, 0.9],
...
#
# file_b    = sio.loadmat('E:\\OLIV3_figures\\OCCITENS\\vert_grad_w_wglvb_occitens_glob_025_annual_isolevm_filtr.mat')
...
cb = fig.colorbar(
    mpl.cm.ScalarMappable(cmap=cmap_LONM, norm=norm_rel),
    extend='both',
    ticks=np.arange(-1,1.2,0.2)*100,
    spacing='proportional',
    orientation='vertical',
...
plt.savefig('2_occitens_global_relerr_rho_vert_grad_VF.png', bbox_inches='tight', dpi=300)
...
for i, ax in enumerate(axs):
    ...
    #ax.set_title(titles[i].format(isopl[0, k_a]) if i == 0 else titles[i], fontsize=16)
