...
fig.suptitle(r'$w$ variance at $\sigma$ 26 kg m$^{-3}$', fontsize = 28, y = 1.05)
...
cbar.set_label(label=r'$variance$ $[log_{10}(m^2$ $s^{-2)}]$',size=22)

#plt.savefig('variance_w_55_V4.png', bbox_inches='tight', dpi=300)
...
plt.savefig('variance_w_55_VF.png', bbox_inches='tight', dpi=300)